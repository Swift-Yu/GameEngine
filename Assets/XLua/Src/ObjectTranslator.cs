    ...
    public partial class ObjectTranslator
	{
        ...
        public bool AllDelegateBridgeReleased()
        {
            foreach (var kv in delegate_bridges)
            {
                if (kv.Value.IsAlive)
                {
                    XLua.DelegateBridge bridge = kv.Value.Target as XLua.DelegateBridge;
                    UnityEngine.Debug.LogError("bridge " + bridge.FirstValue.GetHashCode());
                    UnityEngine.Debug.LogError("AllDelegateBridgeReleased :" + bridge.FirstKey);
                    return false;
                }
            }
            return true;
