...
namespace XLua
{
    public partial class ObjectTranslator
    {
        ...
        class IniterAdderUnityEngineVector2
        {
			...
			static void Init(LuaEnv luaenv, ObjectTranslator translator)
			{
				...
				translator.RegisterPushAndGetAndUpdate<Engine.NetWorkError>(translator.PushEngineNetWorkError, translator.Get, translator.UpdateEngineNetWorkError);
				translator.RegisterPushAndGetAndUpdate<Engine.TaskPriority>(translator.PushEngineTaskPriority, translator.Get, translator.UpdateEngineTaskPriority);
        ...
        int EngineNetWorkError_TypeID = -1;
		int EngineNetWorkError_EnumRef = -1;
        
        public void PushEngineNetWorkError(RealStatePtr L, Engine.NetWorkError val)
        {
            if (EngineNetWorkError_TypeID == -1)
            {
			    bool is_first;
                EngineNetWorkError_TypeID = getTypeId(L, typeof(Engine.NetWorkError), out is_first);
				
				if (EngineNetWorkError_EnumRef == -1)
				{
				    Utils.LoadCSTable(L, typeof(Engine.NetWorkError));
				    EngineNetWorkError_EnumRef = LuaAPI.luaL_ref(L, LuaIndexes.LUA_REGISTRYINDEX);
				}
				
            }
			
			if (LuaAPI.xlua_tryget_cachedud(L, (int)val, EngineNetWorkError_EnumRef) == 1)
            {
			    return;
			}
			
            IntPtr buff = LuaAPI.xlua_pushstruct(L, 4, EngineNetWorkError_TypeID);
            if (!CopyByValue.Pack(buff, 0, (int)val))
            {
                throw new Exception("pack fail fail for Engine.NetWorkError ,value="+val);
            }
			
			LuaAPI.lua_getref(L, EngineNetWorkError_EnumRef);
			LuaAPI.lua_pushvalue(L, -2);
			LuaAPI.xlua_rawseti(L, -2, (int)val);
			LuaAPI.lua_pop(L, 1);
        ...
        public void Get(RealStatePtr L, int index, out Engine.NetWorkError val)
        {
		    LuaTypes type = LuaAPI.lua_type(L, index);
            if (type == LuaTypes.LUA_TUSERDATA )
            {
			    if (LuaAPI.xlua_gettypeid(L, index) != EngineNetWorkError_TypeID)
				{
				    throw new Exception("invalid userdata for Engine.NetWorkError");
				}
                ...
                if (!CopyByValue.UnPack(buff, 0, out e))
                {
                    throw new Exception("unpack fail for Engine.NetWorkError");
                }
				val = (Engine.NetWorkError)e;
                
            }
            else
            {
                val = (Engine.NetWorkError)objectCasters.GetCaster(typeof(Engine.NetWorkError))(L, index, null);
            }
        }
		
        public void UpdateEngineNetWorkError(RealStatePtr L, int index, Engine.NetWorkError val)
        {
            if (LuaAPI.lua_type(L, index) == LuaTypes.LUA_TUSERDATA)
            {
			    if (LuaAPI.xlua_gettypeid(L, index) != EngineNetWorkError_TypeID)
                ...
                if (!CopyByValue.Pack(buff, 0,  (int)val))
                {
                    throw new Exception("pack fail for Engine.NetWorkError ,value="+val);
                }
            }
            else
            {
        ...
        int EngineTaskPriority_TypeID = -1;
		int EngineTaskPriority_EnumRef = -1;
        
        public void PushEngineTaskPriority(RealStatePtr L, Engine.TaskPriority val)
        {
            if (EngineTaskPriority_TypeID == -1)
            {
			    bool is_first;
                EngineTaskPriority_TypeID = getTypeId(L, typeof(Engine.TaskPriority), out is_first);
				
				if (EngineTaskPriority_EnumRef == -1)
				{
				    Utils.LoadCSTable(L, typeof(Engine.TaskPriority));
				    EngineTaskPriority_EnumRef = LuaAPI.luaL_ref(L, LuaIndexes.LUA_REGISTRYINDEX);
				}
				
            }
			
			if (LuaAPI.xlua_tryget_cachedud(L, (int)val, EngineTaskPriority_EnumRef) == 1)
            {
			    return;
			}
			
            IntPtr buff = LuaAPI.xlua_pushstruct(L, 4, EngineTaskPriority_TypeID);
            if (!CopyByValue.Pack(buff, 0, (int)val))
            {
                throw new Exception("pack fail fail for Engine.TaskPriority ,value="+val);
            }
			
			LuaAPI.lua_getref(L, EngineTaskPriority_EnumRef);
			LuaAPI.lua_pushvalue(L, -2);
			LuaAPI.xlua_rawseti(L, -2, (int)val);
			LuaAPI.lua_pop(L, 1);
        ...
        public void Get(RealStatePtr L, int index, out Engine.TaskPriority val)
        {
		    LuaTypes type = LuaAPI.lua_type(L, index);
            if (type == LuaTypes.LUA_TUSERDATA )
            {
			    if (LuaAPI.xlua_gettypeid(L, index) != EngineTaskPriority_TypeID)
				{
				    throw new Exception("invalid userdata for Engine.TaskPriority");
				}
                ...
                if (!CopyByValue.UnPack(buff, 0, out e))
                {
                    throw new Exception("unpack fail for Engine.TaskPriority");
                }
				val = (Engine.TaskPriority)e;
                
            }
            else
            {
                val = (Engine.TaskPriority)objectCasters.GetCaster(typeof(Engine.TaskPriority))(L, index, null);
            }
        }
		
        public void UpdateEngineTaskPriority(RealStatePtr L, int index, Engine.TaskPriority val)
        {
            if (LuaAPI.lua_type(L, index) == LuaTypes.LUA_TUSERDATA)
            {
			    if (LuaAPI.xlua_gettypeid(L, index) != EngineTaskPriority_TypeID)
                ...
                if (!CopyByValue.Pack(buff, 0,  (int)val))
                {
                    throw new Exception("pack fail for Engine.TaskPriority ,value="+val);
                }
            }
            else
            {
	...
	public partial class StaticLuaCallbacks
    {
	    internal static bool __tryArrayGet(Type type, RealStatePtr L, ObjectTranslator translator, object obj, int index)
		{
			...
			else if (type == typeof(Engine.NetWorkError[]))
			{
			    Engine.NetWorkError[] array = obj as Engine.NetWorkError[];
				translator.PushEngineNetWorkError(L, array[index]);
				return true;
			}
			else if (type == typeof(Engine.TaskPriority[]))
			{
			    Engine.TaskPriority[] array = obj as Engine.TaskPriority[];
				translator.PushEngineTaskPriority(L, array[index]);
				return true;
			}
